...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate (Bundle savedInstanceState){
       ...
       // Listapaciente = new ArrayList<Paciente>();
        ...
        if(service.validarConexion(this.getApplicationContext())){
            ...
            service.configurarUrl("http://192.168.0.4:8080/simWebService/resources/PacienteResource?id=1");
            ...
            if(service.conectar(this.getApplicationContext())) {
               ...
               paciente = new Paciente("Maximiliano","Akike","105",111,111,111,111,34809913);
                Listapaciente.add(paciente);
    ...
    private void MostrarFragment(int position) {
        ...
        switch (position) {
            ...
            case 4:
                ...
                fragActivo.setData("LISTAPACIENTE");
    ...
    public void onBackPressed() {
       ...
       }else if( fragActivo.getData()=="LIBROREPORT") {
           System.out.println("LIBROREPORT");
           MostrarFragment(4);
       }
       else{
           MostrarFragment(1);

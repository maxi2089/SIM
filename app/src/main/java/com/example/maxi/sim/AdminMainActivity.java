...
/**
 * Created by yamila on 13/11/2015.
 */
public class AdminMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavIcons = getResources().obtainTypedArray(R.array.navigation_iconos_admin);

        titulos = getResources().getStringArray(R.array.nav_admin_options);

...
public class MedicoMainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavIcons = getResources().obtainTypedArray(R.array.navigation_iconos_medico);

        titulos = getResources().getStringArray(R.array.nav_medico_options);
    ...
    private void MostrarFragment(int position,String origen) {
        ...
        switch (position) {
            ...
            case 6:
                ...
                Intent intent = new Intent(MedicoMainActivity.this,LoginActivity.class);
                startActivity(intent);
                break;
            case 7:
                ...
                position = 4;
                break;
            case 8: fragment = new FarmacoFragment();
                position = 3;
                break;
            case 9: fragment = new ListaVisitasFragment();
                position = 7;
                break;
            default:
